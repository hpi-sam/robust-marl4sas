 ...
 * </p>
 * <ul>
 *   <li>{@link de.mdelab.morisia.comparch.impl.ProvidedInterfaceImpl#getComponent <em>Component</em>}</li>
 *   <li>{@link de.mdelab.morisia.comparch.impl.ProvidedInterfaceImpl#getConnectors <em>Connectors</em>}</li>
 *   <li>{@link de.mdelab.morisia.comparch.impl.ProvidedInterfaceImpl#getFailures <em>Failures</em>}</li>
 *   <li>{@link de.mdelab.morisia.comparch.impl.ProvidedInterfaceImpl#getPerformanceStats <em>Performance Stats</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProvidedInterfaceImpl extends InterfaceImpl implements ProvidedInterface {
	...
	public Component getComponent() {
		if (eContainerFeatureID() != ComparchPackage.PROVIDED_INTERFACE__COMPONENT) return null;
	...
	public void setComponent(Component newComponent) {
		if (newComponent != eInternalContainer() || (eContainerFeatureID() != ComparchPackage.PROVIDED_INTERFACE__COMPONENT && newComponent != null)) {
			...
			if (newComponent != null)
				msgs = ((InternalEObject)newComponent).eInverseAdd(this, ComparchPackage.COMPONENT__PROVIDED_INTERFACES, Component.class, msgs);
			msgs = basicSetComponent(newComponent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComparchPackage.PROVIDED_INTERFACE__COMPONENT, newComponent, newComponent));
	}
	...
	public EList<Connector> getConnectors() {
		if (connectors == null) {
			connectors = new EObjectWithInverseResolvingEList<Connector>(Connector.class, this, ComparchPackage.PROVIDED_INTERFACE__CONNECTORS, ComparchPackage.CONNECTOR__TARGET);
		}
		return connectors;
	}
	...
	public EList<Failure> getFailures() {
		if (failures == null) {
			failures = new EObjectContainmentWithInverseEList<Failure>(Failure.class, this, ComparchPackage.PROVIDED_INTERFACE__FAILURES, ComparchPackage.FAILURE__INTERFACE);
		}
		return failures;
	}
	...
	public EList<PerformanceStats> getPerformanceStats() {
		if (performanceStats == null) {
			performanceStats = new EObjectContainmentWithInverseEList<PerformanceStats>(PerformanceStats.class, this, ComparchPackage.PROVIDED_INTERFACE__PERFORMANCE_STATS, ComparchPackage.PERFORMANCE_STATS__INTERFACE);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case ComparchPackage.PROVIDED_INTERFACE__FAILURES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getFailures()).basicAdd(otherEnd, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ComparchPackage.PROVIDED_INTERFACE__COMPONENT:
				return eInternalContainer().eInverseRemove(this, ComparchPackage.COMPONENT__PROVIDED_INTERFACES, Component.class, msgs);
		}
