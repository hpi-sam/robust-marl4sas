 ...
 * </p>
 * <ul>
 *   <li>{@link de.mdelab.morisia.comparch.impl.ParameterImpl#getValue <em>Value</em>}</li>
 *   <li>{@link de.mdelab.morisia.comparch.impl.ParameterImpl#isLazyAdaptation <em>Lazy Adaptation</em>}</li>
 *   <li>{@link de.mdelab.morisia.comparch.impl.ParameterImpl#getComponent <em>Component</em>}</li>
 *   <li>{@link de.mdelab.morisia.comparch.impl.ParameterImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterImpl extends ArchitecturalElementImpl implements Parameter {
	...
	public void setLazyAdaptation(boolean newLazyAdaptation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComparchPackage.PARAMETER__LAZY_ADAPTATION, oldLazyAdaptation, lazyAdaptation));
	}
	...
	public Component getComponent() {
		if (eContainerFeatureID() != ComparchPackage.PARAMETER__COMPONENT) return null;
	...
	public void setComponent(Component newComponent) {
		if (newComponent != eInternalContainer() || (eContainerFeatureID() != ComparchPackage.PARAMETER__COMPONENT && newComponent != null)) {
			...
			if (newComponent != null)
				msgs = ((InternalEObject)newComponent).eInverseAdd(this, ComparchPackage.COMPONENT__PARAMETERS, Component.class, msgs);
			msgs = basicSetComponent(newComponent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComparchPackage.PARAMETER__COMPONENT, newComponent, newComponent));
	}
	...
	public ParameterType getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ComparchPackage.PARAMETER__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public NotificationChain basicSetType(ParameterType newType, NotificationChain msgs) {
		...
		type = newType;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ComparchPackage.PARAMETER__TYPE, oldType, newType);
	...
	public void setType(ParameterType newType) {
		if (newType != type) {
			NotificationChain msgs = null;
			if (type != null)
				msgs = ((InternalEObject)type).eInverseRemove(this, ComparchPackage.PARAMETER_TYPE__INSTANCES, ParameterType.class, msgs);
			if (newType != null)
				msgs = ((InternalEObject)newType).eInverseAdd(this, ComparchPackage.PARAMETER_TYPE__INSTANCES, ParameterType.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ComparchPackage.PARAMETER__COMPONENT:
				return eInternalContainer().eInverseRemove(this, ComparchPackage.COMPONENT__PARAMETERS, Component.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ComparchPackage.PARAMETER__VALUE:
				return getValue();
			case ComparchPackage.PARAMETER__LAZY_ADAPTATION:
