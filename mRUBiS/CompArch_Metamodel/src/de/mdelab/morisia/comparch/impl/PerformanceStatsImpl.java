 ...
 * </p>
 * <ul>
 *   <li>{@link de.mdelab.morisia.comparch.impl.PerformanceStatsImpl#getMinTime <em>Min Time</em>}</li>
 *   <li>{@link de.mdelab.morisia.comparch.impl.PerformanceStatsImpl#getMaxTime <em>Max Time</em>}</li>
 *   <li>{@link de.mdelab.morisia.comparch.impl.PerformanceStatsImpl#getTotalTime <em>Total Time</em>}</li>
 *   <li>{@link de.mdelab.morisia.comparch.impl.PerformanceStatsImpl#getInvocationCount <em>Invocation Count</em>}</li>
 *   <li>{@link de.mdelab.morisia.comparch.impl.PerformanceStatsImpl#getInterface <em>Interface</em>}</li>
 *   <li>{@link de.mdelab.morisia.comparch.impl.PerformanceStatsImpl#getMethod <em>Method</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PerformanceStatsImpl extends ArchitecturalElementImpl implements PerformanceStats {
	...
	public void setMinTime(long newMinTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComparchPackage.PERFORMANCE_STATS__MIN_TIME, oldMinTime, minTime));
	}
	...
	public void setMaxTime(long newMaxTime) {
		...
		maxTime = newMaxTime;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComparchPackage.PERFORMANCE_STATS__MAX_TIME, oldMaxTime, maxTime));
	}
	...
	public void setTotalTime(long newTotalTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComparchPackage.PERFORMANCE_STATS__TOTAL_TIME, oldTotalTime, totalTime));
	}
	...
	public void setInvocationCount(long newInvocationCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComparchPackage.PERFORMANCE_STATS__INVOCATION_COUNT, oldInvocationCount, invocationCount));
	}
	...
	public ProvidedInterface getInterface() {
		if (eContainerFeatureID() != ComparchPackage.PERFORMANCE_STATS__INTERFACE) return null;
	...
	public void setInterface(ProvidedInterface newInterface) {
		if (newInterface != eInternalContainer() || (eContainerFeatureID() != ComparchPackage.PERFORMANCE_STATS__INTERFACE && newInterface != null)) {
			...
			if (newInterface != null)
				msgs = ((InternalEObject)newInterface).eInverseAdd(this, ComparchPackage.PROVIDED_INTERFACE__PERFORMANCE_STATS, ProvidedInterface.class, msgs);
			msgs = basicSetInterface(newInterface, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComparchPackage.PERFORMANCE_STATS__INTERFACE, newInterface, newInterface));
	}
	...
	public MethodSpecification getMethod() {
		if (method != null && method.eIsProxy()) {
			...
			if (method != oldMethod) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ComparchPackage.PERFORMANCE_STATS__METHOD, oldMethod, method));
			}
		}
		return method;
	}
	...
	public void setMethod(MethodSpecification newMethod) {
		...
		method = newMethod;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComparchPackage.PERFORMANCE_STATS__METHOD, oldMethod, method));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ComparchPackage.PERFORMANCE_STATS__INTERFACE:
				return eInternalContainer().eInverseRemove(this, ComparchPackage.PROVIDED_INTERFACE__PERFORMANCE_STATS, ProvidedInterface.class, msgs);
		}
